...
export class LancamentosPesquisaComponent {
  lancamentos = [
    { tipo: 'DESPESA', descricao: 'Compra de pão', dataVencimento: new Date(2017, 9, 11),
    ...
    { tipo: 'DESPESA', descricao: 'Impostos', dataVencimento: new Date(2017, 0, 6),
    ...
    { tipo: 'RECEITA', descricao: 'Venda de carro', dataVencimento: new Date(2017, 2, 11),
